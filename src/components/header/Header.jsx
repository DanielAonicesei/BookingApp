import { faCalendarDays, faSmile } from "@fortawesome/free-regular-svg-icons"
    ...
    <div className="header">
      <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
        ...
        <p className="headerDesc">
          Get rewarded for your travels with a free Danbooking account
        </p>
        ...
        <div className="headerSearch">
          ...
          <div className="headerSearchItem">
            <FontAwesomeIcon icon={faSmile} className="headerIcon" />
